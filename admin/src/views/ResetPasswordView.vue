<template>
  <div class="d-flex align-center justify-center" style="height: 100vh">
    <v-sheet width="400" class="mx-auto">
      ...
      <ResetPasswordForm @submit="submitResetPassword" v-if="!changePassword" :loading="loading" />
      <ChangePasswordForm :email="email" @submit="submitChangePassword" v-else :loading="loading" />
      <div class="mt-2">
        <p class="text-body-2">
          Ya tenes cuenta?
